...
import {SimilarGoalItem} from '@/components/SimilarGoalItem/SimilarGoalItem';
import {Svg} from '@/components/Svg/Svg';
import {Title} from '@/components/Title/Title';
import {useBem} from '@/hooks/useBem';
import {IGoal} from '@/typings/goal';
import {getSimilarGoals} from '@/utils/api/get/getSimilarGoals';
import {createMergeRequest} from '@/utils/api/goals';
import {debounce} from '@/utils/time/debounce';

import './goal-merge-request-modal.scss';
