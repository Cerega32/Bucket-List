...
import {getWeeklyLeaders} from '@/entities/user/api/getWeeklyLeaders';
import {defaultInfoStats} from '@/entities/user/lib/defaultInfoStats';
import {IInfoStats, IPreviousWeekLeaders, IWeekPeriod, IWeeklyLeader} from '@/entities/user/model/types';
import {useBem} from '@/shared/lib/hooks/useBem';
import {EmptyState} from '@/shared/ui/EmptyState/EmptyState';
import {Title} from '@/shared/ui/Title/Title';
import {LeaderBoard} from '@/widgets/leader-board/LeaderBoard';
import {LeaderPedestal} from '@/widgets/leaders/LeaderPedestal';
import {LeadersSkeleton} from '@/widgets/leaders/LeadersSkeleton';
import '@/widgets/leaders/leaders.scss';
