...
import {ScratchMapCountry, mapApi} from '@/entities/goal/api/mapApi';
...
import {computeMapColorAssignment} from '@/widgets/countries-scratch-map/lib/computeMapColorAssignment';
import {getMicroStateTransform} from '@/widgets/countries-scratch-map/lib/getMicroStateTransform';
import {resolveGeoIso} from '@/widgets/countries-scratch-map/lib/resolveGeoIso';
import {
	SCRATCH_MAP_COUNTRY_PALETTE,
	SCRATCH_MAP_GLOBE_FILL,
	SCRATCH_MAP_NEUTRAL_FILL,
	SCRATCH_MAP_UNVISITED_PALETTE,
} from '@/widgets/countries-scratch-map/lib/scratchMapPalette';

import '@/widgets/countries-scratch-map/countries-scratch-map.scss';
