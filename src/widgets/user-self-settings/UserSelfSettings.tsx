...
import {deleteAvatar} from '@/entities/user/api/deleteAvatar';
import {postAvatar} from '@/entities/user/api/postAvatar';
import {postCover} from '@/entities/user/api/postCover';
import {postResendConfirmationEmail} from '@/entities/user/api/postResendConfirmationEmail';
import {putUserInfo} from '@/entities/user/api/putUserInfo';
...
import {countriesArr} from '@/widgets/countries-scratch-map/lib/countries';
import '@/widgets/user-self-settings/user-self-settings.scss';
