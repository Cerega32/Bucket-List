...
import {checkPaymentStatus, confirmPayment} from '@/entities/subscription/api/subscription';
...
import '@/widgets/user-self-subscription/ui/PaymentReturnModal/payment-return-modal.scss';
