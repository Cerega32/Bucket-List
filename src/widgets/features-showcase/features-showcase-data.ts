...
import {IGoalProgressEntry} from '@/entities/goal/api/goals';
import {GoalWithLocation, ScratchMapCountry} from '@/entities/goal/api/mapApi';
import {ICategory, IGoal, IGoalFolder, IRegularGoalStatistics, IShortGoal, IShortList} from '@/entities/goal/model/types';
import {IUserStatistics, IWeeklyProgressItem} from '@/entities/user/model/types';
import {CompareFriendData} from '@/features/compare-friend/CompareFriendModal';
...
export const COMING_SOON_ITEMS: ComingSoonItem[] = [
	...
	{
		icon: 'chart',
		title: 'Лидеры среди друзей',
		description: 'Таблица лидеров только с твоими друзьями — соревнуйся с теми, кого знаешь, а не со всеми подряд.',
		iconAccent: 'red',
	},
	{
		icon: 'trophy',
	...
	{
		icon: 'eye',
		title: 'Кто ещё с тобой',
		description: 'Наведи на «добавили» или «выполнили» — увидишь фото друзей, которые уже взяли или закрыли эту цель.',
		iconAccent: 'red',
	},
	// TODO: вернуть, когда выпустим в прод любую из 6 открытых фич
	// {
	// 	icon: 'award',
