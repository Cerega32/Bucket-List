...
import {DEMO_SCRATCH_MAP_COUNTRIES, DEMO_WORLD_MAP_GOALS} from '@/widgets/features-showcase/features-showcase-data';
import {GoalMapMulti} from '@/widgets/goal-map/GoalMapMulti';

import '@/widgets/features-showcase/showcase-maps-slideshow.scss';
