...
import {searchUsers, sendFriendRequest} from '@/entities/friend/api/friends';
...
import {IFriendSearchResult} from '@/entities/user/model/types';
...
import '@/widgets/user-search/user-search.scss';
