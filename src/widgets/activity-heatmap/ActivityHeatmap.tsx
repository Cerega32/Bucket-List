...
import {getGoalActivity} from '@/entities/goal/api/getGoalActivity';
...
import {ActivityHeatmapSkeleton} from '@/widgets/activity-heatmap/ActivityHeatmapSkeleton';
import {
	ActivityPeriodSelection,
	buildActivityPeriodSelectOptions,
	getActivityPeriodActiveOption,
	parseActivityPeriodSelectIndex,
} from '@/widgets/activity-heatmap/lib/activityHeatmapPeriods';

import type {IAchievement} from '@/entities/achievement/model/types';

import '@/widgets/activity-heatmap/activity-heatmap.scss';
