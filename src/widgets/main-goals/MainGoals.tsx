...
import {IComplexity} from '@/entities/goal/model/types';
import {MainCards} from '@/entities/goal/ui/MainCards/MainCards';
import {IMainGoals, UserStore} from '@/entities/user/model/UserStore';
...
import {MainGoalsSkeleton} from '@/widgets/main-goals/MainGoalsSkeleton';
import '@/widgets/main-goals/main-goals.scss';
