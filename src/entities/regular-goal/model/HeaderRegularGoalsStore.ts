...
import {getRegularGoalStatistics} from '@/entities/goal/api/goals';
...
import {computeRegularGoalsHeaderStats} from '@/entities/regular-goal/lib/regularGoalTodayVisibility';
