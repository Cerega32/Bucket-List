import {isPremiumSubscriptionActive} from '@/entities/regular-goal/lib/isPremiumSubscriptionActive';
import {REGULAR_GOALS_PREMIUM_LIMIT_TEXT} from '@/entities/regular-goal/lib/regularGoalsPremiumLimitContent';
// eslint-disable-next-line max-len
import {notifyRegularGoalsPremiumLimitReached} from '@/entities/regular-goal/ui/RegularGoalsPremiumLimitMessage/RegularGoalsPremiumLimitMessage';
import {IUserInfo} from '@/entities/user/model/types';
import {UserStore} from '@/entities/user/model/UserStore';
import {NotificationStore} from '@/shared/model/NotificationStore';

export {isPremiumSubscriptionActive} from '@/entities/regular-goal/lib/isPremiumSubscriptionActive';
