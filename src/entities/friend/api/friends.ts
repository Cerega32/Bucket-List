...
import {IFriendCompareResponse, IFriendRequestsResponse, IFriendSearchResponse, IFriendsResponse} from '@/entities/user/model/types';
import {DELETE, GET, POST} from '@/shared/api/http/requests';
