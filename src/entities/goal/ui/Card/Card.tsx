...
import {getCatalogDeleteHint} from '@/entities/goal/lib/catalogRejectionReasons';
import {ICatalogReviewStatus, IShortGoal, IShortList} from '@/entities/goal/model/types';
import {Tags} from '@/entities/goal/ui/Tags/Tags';
import {isScratchMapList, SCRATCH_MAP_PAGE_URL} from '@/entities/goal-list/lib/scratchMapList';
import {UserStore} from '@/entities/user/model/UserStore';
import {useBem} from '@/shared/lib/hooks/useBem';
import useScreenSize from '@/shared/lib/hooks/useScreenSize';
import {emitConfettiFromElement} from '@/shared/lib/ui/emitConfetti';
...
import '@/entities/goal/ui/Card/card.scss';
