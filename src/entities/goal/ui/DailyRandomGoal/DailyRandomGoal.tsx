...
import {getRandomActiveGoal} from '@/entities/goal/api/getRandomActiveGoal';
...
import {revealGoalWithParticles} from '@/shared/lib/animation/goalParticleAnimation';
...
import '@/entities/goal/ui/DailyRandomGoal/daily-random-goal.scss';
				...
				<Link to={`/goals/${goal.code}`} className={element('preview')}>
					...
					<div className={element('info', {blurred: isInfoBlurred})}>
						...
						<div className={element('tags')}>
							...
							<Tag text={getComplexity[goal.complexity]} theme="integrate" icon={goal.complexity} />
						</div>
					</div>
				</Link>
