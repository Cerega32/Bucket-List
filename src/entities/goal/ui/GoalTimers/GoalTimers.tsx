...
import {getUserTimers, TimerInfo} from '@/entities/goal/api/getGoalTimer';
import {GoalTimersSkeleton} from '@/entities/goal/ui/GoalTimers/GoalTimersSkeleton';
...
import '@/entities/goal/ui/GoalTimers/goal-timers.scss';
