...
import {ITimer} from '@/entities/dashboard/model/types';
import {formatDistanceToNow} from '@/shared/lib/date/formatDistanceToNow';
...
import '@/entities/goal/ui/UpcomingTimers/upcoming-timers.scss';
