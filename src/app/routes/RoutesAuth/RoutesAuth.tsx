...
import {ScrollToTopOnRouteChange} from '@/shared/ui/ScrollToTopOnRouteChange/ScrollToTopOnRouteChange';

import '@/app/routes/RoutesAuth/routes-auth.scss';
	...
	return (
		<main className="main">
			...
			<Routes>
				...
				/>
				<Route
					path="/user/self/pending-review/merges"
					element={<ProtectedRoute element={<PageUserSelf page="isUserSelfPending" subPage="merges" />} />}
				/>
				<Route
