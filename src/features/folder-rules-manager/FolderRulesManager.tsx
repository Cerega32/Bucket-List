...
import {FolderRulesManagerSkeleton} from '@/features/folder-rules-manager/FolderRulesManagerSkeleton';
...
import '@/features/folder-rules-manager/folder-rules-manager.scss';
