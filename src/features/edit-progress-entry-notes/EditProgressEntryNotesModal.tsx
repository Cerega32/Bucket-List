...
import {IGoalProgressEntry, updateGoalProgressEntryNotes} from '@/entities/goal/api/goals';
...
import '@/features/edit-progress-entry-notes/edit-progress-entry-notes-modal.scss';
