...
import {postAddReview} from '@/entities/comment/api/postAddReview';
import {putEditReview} from '@/entities/comment/api/putEditReview';
import {IComment} from '@/entities/comment/model/types';
import {selectComplexity} from '@/entities/goal/lib/complexity';
import {COMMENT_TEXT_MAX_LENGTH} from '@/entities/goal/lib/goalConstants';
...
import '@/features/add-review/add-review.scss';
...
export const AddReview: FC<AddReviewProps> = (props) => {
	...
	const editingComment = modalProps?.editComment as IComment | undefined;
