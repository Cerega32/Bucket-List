...
import {checkEmail} from '@/entities/user/api/checkEmail';
import {checkUsername} from '@/entities/user/api/checkUsername';
import {getRegistrationCatalogGoals} from '@/entities/user/api/getRegistrationCatalogGoals';
import {postRegistration} from '@/entities/user/api/postRegistration';
import {registrationGoalsSync} from '@/entities/user/api/registrationGoalsSync';
import {ICategoryGoals, IMainGoals} from '@/entities/user/model/UserStore';
...
import '@/features/registration/registration.scss';
							...
							<FieldCheckbox
								...
								text={
									<div>
										...
										и принимаю{' '}
										<Link to="/agreement" className={element('consent-link')} target="_blank" rel="noopener noreferrer">
