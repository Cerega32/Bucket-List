...
import {getComplexity, selectComplexity} from '@/entities/goal/lib/complexity';
import {getGoalListTitleFieldErrors, GOAL_LIST_TITLE_MIN_LENGTH, isGoalListTitleInvalid} from '@/entities/goal/lib/goalConstants';
import {isCatalogResubmitOnCooldown} from '@/entities/goal/lib/resubmitCooldown';
import {ICategory, IGoal, IShortGoal} from '@/entities/goal/model/types';
...
import '@/features/edit-goal-list/edit-goal-list.scss';
