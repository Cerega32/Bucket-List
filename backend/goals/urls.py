...
from .views import (
    get_goal_by_code,
    add_goal_to_user,
    remove_goal_from_user,
    mark_goal,
    lists_containing_goal,
    popular_goals,
    goals_by_category,
)
...
urlpatterns = [
    ...
    path(
        "api/goals/<slug:code>/remove/",
        remove_goal_from_user,
        name="remove-goal-from-user",
    ),
    path("api/goals/<slug:code>/mark/", mark_goal, name="mark-goal"),
    path(
        "api/goals/<slug:code>/lists/",
        lists_containing_goal,
        name="lists_containing_goal",
    ),
    path(
        "api/goals/<slug:code>/popular/",
        popular_goals,
        name="popular_goals",
    ),
    path(
        "api/goals/<slug:code>/all/",
        goals_by_category,
