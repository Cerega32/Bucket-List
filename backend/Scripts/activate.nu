...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Cereg\Documents\GitHub\project\Bucket-List\backend'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Cereg\Documents\GitHub\project\Bucket-List\backend\Scripts\deactivate.nu'
