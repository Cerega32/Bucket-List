...
class CommentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Comment
        fields = ('id', 'complexity', 'user', 'user_avatar', 'user_name', 'user_nickname', 'text', 'date_created', 'photos', 'user_total_completed_goals', 'likes_count', 'dislikes_count', 'has_liked', 'has_disliked')
